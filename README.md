...
# Overview
This repository contains the basic implementation of our proposed HFMCA (Hierarchical Functional Maximize Analyze) method for EEG-based brain decoding, along with the corresponding training functions. HFMCA introduces orthonormal feature learning to enhance the representation quality of EEG signals for improved brain state classification.

# Repository Contents

Core Implementation: Basic HFMCA model architecture and training pipeline

Training Functions: Complete training scripts with our proposed methodology

Data Loading: Functions for reading and preprocessing EEG datasets
